          ...
          <div class="col-md-12">
            ...
            <form id="form_customers" class="text-left  was-validated" action="#!" onsubmit="sendData(this.id,event);return false">
              ...
              <div class="form-row mb-1">
                ...
                <div class="col-md-4 mb-1">
                  <!-- Select  -->
                  <label class="bmd-label-floating">¿Es usuario?</label>
                  <div class="custom-control custom-switch">
                    <input type="checkbox" class="custom-control-input" id="Client_user" onchange="viewPassword(this.id)">
                    <label class="custom-control-label" for="Client_user">Encienda si el cliente es usuario también</label>
                  </div>
                </div>
                <div class="col-md-4 mb-1 password hidden" style="display: none;">
                  <!-- Contraseña -->
                  <label class="bmd-label-floating"> Contraseña</label>
                  <input type="password" pattern=".{6,}"id="Login_password" title="Ocho o más caracteres" class="form-control form-control-sm pass " placeholder="Contraseña">
                  <div class="valid-feedback">Ok!</div>
                ...
                <div class="col-md-4 mb-1 password hidden" style="display: none;">
                  ...
                  <div class="input-group mb-2">
                    <input type="password" pattern=".{6,}" id="Repeat_password" title="Ocho o más caracteres" class="form-control form-control-sm no-valid pass" onkeyup="confirmPass()" placeholder="Confirme Contraseña">
                    <div class="input-group-prepend">
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input btn-primary no-valid" id="defaultUnchecked">
