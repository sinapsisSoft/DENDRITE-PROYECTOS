...
<body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="container mx-auto">
              <form class="navbar-form" id="formSearchQuotation">
                <div class="row">
                  <div class="input-group col-10 col-md-5">
                    <label for="Res_iniDate">Fecha Inicial</label>
                    <input type="date" id="Quo_iniDate" value="" class="form-control bg-light border-0 small">
                  </div>
                  <div class="input-group col-10 col-md-5">
                    <label for="Res_finDate">Fecha Final</label>
                    <input type="date" id="Quo_finDate" value="" class="form-control bg-light border-0 small">
                  </div>
                  <div class="col-2 col-md-2">
                    <button type="submit" class="btn btn-primary" onclick="searchQuotation(event);return false">
  ...
  <script>
    window.onload = loadViewQuotations;
  </script>
</body>
