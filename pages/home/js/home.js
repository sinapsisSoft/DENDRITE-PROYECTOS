...
function ListRequest(idElement, json) {
  let obj = document.getElementById(idElement);
  for (i = 0; i < json.length; i++) {
    obj.innerHTML += "<li><i class='text-warning fas fa-exclamation'></i><a href='../request/request.php?Req_id=" + json[i]["Req_id"] +"'><span> " + json[i]["Req_subject"] + "</span></a></li>";
  }
}