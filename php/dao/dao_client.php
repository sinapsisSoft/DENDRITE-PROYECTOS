...
class DaoClient
{
    ...
    public function newClient($objClient)
    {
        try {
            ...
            if ($con != null) {
                $dataClient = $objClient->__getId().",'" . $objClient->__getName() . "','" . $objClient->__getIdentification() . "','" . $objClient->__getAddress() . "','" . $objClient->__getTel() . "','" . $objClient->__getEmail() . "','" . $objClient->__getContactName() . "','" . $objClient->__getContactTitle() . "','" . $objClient->__getContactTel() . "','" . $objClient->__getContactCel() . "','" . $objClient->__getContactEmail() . "'," . $objClient->__getStatId() . "," . $objClient->__getUser() . ",'" . $objClient->__getPassword() . "'," . $objClient->__getCompany();
                //echo "CALL sp_client_insert_update (" . $dataClient . ")";
