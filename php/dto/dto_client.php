...
class DtoClient
{
    ...
    public function __setClient($id,$name, $identification, $address, $tel, $email, $contactName, $contactTitle, $contactTel, $contactCel, $contactEmail,$state, $user, $password, $company)
    {
        $this->Client_id = $id;
