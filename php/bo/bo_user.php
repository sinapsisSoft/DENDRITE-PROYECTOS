...
class BoUser
{
  ...
  #Description: Function select user identification
  public function selectUserIdentification($email)
  {
    try {
      $intValidate = $this->objDao->selectUserIdentification($email);
    } catch (Exception $e) {
      echo 'Exception captured: ', $e->getMessage(), "\n";
      $intValidate = 0;
    }
  ...
  #Description: Function select user id
  public function selectGetUser($email)
  {
    try {
      $intValidate = $this->objDao->selectGetUser($email);
    } catch (Exception $e) {
      echo 'Exception captured: ', $e->getMessage(), "\n";
      $intValidate = 0;
    }
...
if (isset($data->GET)) {
  ...
  if ($data->GET == "GET_USER_ID") {
    echo $obj->selectUserIdentification($data->User_email);
  }
}
