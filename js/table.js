...
//**Method create Table Customers **/
  ...
  createtableProcessType() {
    ...
    for (let i = 0; i < this.jSon.length; i++) {
      objtbody += '<tr><td>' + this.jSon[i].Ptype_name + '</td><td>' + this.jSon[i].Ptype_description + '</td><td><button onclick="getDataEdit(' + this.jSon[i].Ptype_id + ');clearForm(' + "'form_processType'" + ', 0);" class="btn btn-primary" style="margin:0; padding:5px" value=""><i class="material-icons">border_color</i></button></td></tr>';
    }
    objtbody += '</tbody>';
    objThead += '</thead>';
    table = objThead + objtbody;
  ...
  createtableProcess() {
    ...
    for (let i = 0; i < this.jSon.length; i++) {
      objtbody += '<tr><td>' + this.jSon[i].Proc_internConsec + '</td><td>' + this.jSon[i].Client_name + '</td><td>' + this.jSon[i].Proc_building + '</td><td>' + this.jSon[i].Proc_origin + '</td><td>' + this.jSon[i].Proc_office + '</td><td>' + this.jSon[i].Proc_filing + '</td><td>' + this.jSon[i].Proc_consecutive + '</td><td>' + this.jSon[i].Proc_attorney + '</td><td>' + this.jSon[i].Proc_status + '</td><td><a href="process.php?Proc_id='+ this.jSon[i].Proc_id + '" class="btn btn-primary" style="margin:0; padding:5px" value=""><i class="material-icons">border_color</i></a></td></tr>';
    }
    objtbody += '</tbody>';
    objThead += '</thead>';
    table = objThead + objtbody;
  ...
  createtableProcessByClient() {
    ...
    for (let i = 0; i < this.jSon.length; i++) {
      objtbody += '<tr><td>' + this.jSon[i].Client_name + '</td><td>' + this.jSon[i].Proc_count + '</td><td><a href="dashboard.php?Client_id='+ this.jSon[i].Client_id + '" class="btn btn-primary" style="margin:0; padding:5px" value=""><i class="material-icons">visibility</i></a></td></tr>';
    }
    objtbody += '</tbody>';
    objThead += '</thead>';
    table = objThead + objtbody;
  ...
  createtableRequest() {
    ...
    for (let i = 0; i < this.jSon.length; i++) {      
      let className = this.jSon[i].Stat_name.replace(/\s+/g, '');
      objtbody += '<tr>' + 
      '<td>' + this.jSon[i].User_name+ '</td>'+
      '<td>' + this.jSon[i].Req_subject+ '</td>'+
      '<td>' + this.jSon[i].Act_date+ '</td>'+
      '<td>' + this.jSon[i].Stat_name+ '</td>' +         
      '<td><div class="square ' + className + ' mx-auto" title='+ this.jSon[i].Stat_name +'></div></td>'+         
      '<td><a href="request.php?Req_id='+ this.jSon[i].Req_id + '" class="btn btn-primary" style="margin:0; padding:5px" value=""><i class="material-icons">visibility</i></a></td></tr>';
    }
    objtbody += '</tbody>';
    objThead += '</thead>';
    table =  objThead+objtbody;
  ...
  createtableAction() {
    ...
    for (let i = 0; i < this.jSon.length; i++) {   
      let className = this.jSon[i].Stat_name.replace(/\s+/g, '');   
      objtbody += '<tr>' + 
      '<td>' + this.jSon[i].Act_observation+ '</td>'+
      '<td>' + this.jSon[i].Act_date+ '</td>'+
      '<td>' + this.jSon[i].Stat_name+ '</td>'+
      '<td><div class="square ' + className + ' mx-auto" title='+ this.jSon[i].Stat_name +'></div></td></tr>';
    }
    objtbody += '</tbody>';
    objThead += '</thead>';
    table =  objThead+objtbody;
