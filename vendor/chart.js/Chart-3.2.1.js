...
! function (t, e) {
  ...
  class Nn {
    ...
    getOptionScopes(t, e, i) {
      ...
      const r = new Set;
      e.forEach((e => {
        t && (r.add(t), e.forEach((e => Hn(r, t, e)))), e.forEach((t => Hn(r, n, t))), e.forEach((t => Hn(r, ft[o] || {}, t))), e.forEach((t => Hn(r, xt, t))), e.forEach((t => Hn(r, gt, t)))
      }));
      const l = [...r];
  ...
  class Ls extends Xi {
    ...
    buildTicks() {
      ...
      const o = function (t, e) {
        ...
        for (p && (i.push({
            value: o
          }), y <= o && k++, Tt(Math.round((y + k * M) * _) / _, o, b * (h ? ("" + o).length : 1)) && k++); k < w; ++k) i.push({
